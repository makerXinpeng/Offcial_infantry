...
void CloudMotor_Config(void)
{
    ...
    //pitch电机限幅
    gimbal_control.gimbal_pitch_motor.max_relative_angle = 0.4;//向下限幅  旧步兵：0.8  官方步兵：0.4
    gimbal_control.gimbal_pitch_motor.min_relative_angle = -0.3;//向上限幅 旧步兵：-1.6 官方步兵：-0.3
    gimbal_control.gimbal_pitch_motor.offset_ecd = 6200;//官方步兵6200 旧步兵5500 英雄 4596
    //pitch电机数据初始化
